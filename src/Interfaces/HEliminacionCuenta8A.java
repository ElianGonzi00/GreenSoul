 ...
 * @author elian
 */
public class HEliminacionCuenta8A extends javax.swing.JFrame {

    /**
     * Creates new form HEliminaionCuenta8A
     */
    public HEliminacionCuenta8A() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HEliminacionCuenta8A.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HEliminacionCuenta8A().setVisible(true);
            }
        });
    }
