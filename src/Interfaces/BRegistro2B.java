 ...
 * @author elian
 */
public class BRegistro2B extends javax.swing.JFrame {

    /**
     * Creates new form BRegistro2B
     */
    public BRegistro2B() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BRegistro2B.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BRegistro2B().setVisible(true);
            }
        });
    }
