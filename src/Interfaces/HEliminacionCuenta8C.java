 ...
 * @author elian
 */
public class HEliminacionCuenta8C extends javax.swing.JFrame {

    /**
     * Creates new form HEliminacionCuenta8C
     */
    public HEliminacionCuenta8C() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HEliminacionCuenta8C.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HEliminacionCuenta8C().setVisible(true);
            }
        });
    }
