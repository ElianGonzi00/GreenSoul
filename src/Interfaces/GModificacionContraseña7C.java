 ...
 * @author elian
 */
public class GModificacionContraseña7C extends javax.swing.JFrame {

    /**
     * Creates new form GModificacionContraseña7D
     */
    public GModificacionContraseña7C() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GModificacionContraseña7C.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GModificacionContraseña7C().setVisible(true);
            }
        });
    }
